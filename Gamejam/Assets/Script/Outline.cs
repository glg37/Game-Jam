...
public class Outline : MonoBehaviour
{
    ...
    void Awake()
    {
        // Sempre encontra os Renderers desse objeto
        renderers = GetComponentsInChildren<Renderer>();

        outlineMaskMaterial = Instantiate(
            Resources.Load<Material>(@"Materials/OutlineMask")
        );

        outlineFillMaterial = Instantiate(
        ...
        {
            Debug.LogError(
                "QuickOutline: não foi possível encontrar OutlineMask ou OutlineFill em Resources/Materials."
            );
            return;
        }
    ...
    void OnEnable()
    {
        // Segurança: garante que os Renderers existem
        if (renderers == null)
        {
            renderers = GetComponentsInChildren<Renderer>();
        }
        ...
        foreach (var renderer in renderers)
        {
            ...
            // Evita adicionar o mesmo material várias vezes
    ...
    void LoadSmoothNormals()
    {
        ...
        foreach (
            ...
            in GetComponentsInChildren<SkinnedMeshRenderer>()
        )
        {
            ...
            skinnedMeshRenderer.sharedMesh.uv4 =
                new Vector2[
